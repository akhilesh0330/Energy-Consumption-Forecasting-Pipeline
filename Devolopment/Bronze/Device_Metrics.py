...
energy_df = (
    spark.read
    .format("parquet")
    .load(base_transformed_path + "device_metrics_stream_v2.parquet")
)
...
target_table = "bronze.bronze_sch.Device_Metrics"
...
FILE_NAME = "device_metrics_stream_v2.parquet"
TARGET_TABLE = "bronze.bronze_sch.Device_Metrics"
...
try:
    ...
    inserted_rows = device_bronze.count()
